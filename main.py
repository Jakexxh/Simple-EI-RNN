...
parser.add_argument("-tv", "--task_version", default='fd', help="rt/fd")
parser.add_argument("--init_state_trainable", default=True, help="Set if init sate trainable")
parser.add_argument("-e_num", "--epoch_num", default=80, help="max num of epochs for training")
...
parser.add_argument("--model_date", default='20200120-224053')
...
SGD_p = {
    ...
    'vanish_grad_reg': 2,
    'tau': 100,
    'train_t_step': 20, # TODO: origin is 20
    'test_t_step': 0.5,
    'ini_spe_r': 1.5,
    'minibatch_size': 20,
    'baseline_input': 0.2,
    ...
    'rr_noise_std': 0.15,
    'mini_w_threshold': 10 ** -8  # TODO: origin is 10**-4
}
